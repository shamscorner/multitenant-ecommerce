  ...
  return (
    <footer className="flex flex-col md:flex-row border-t justify-between items-center gap-6 md:gap-0 font-medium p-6 bg-white">
      ...
      <div className="flex items-center gap-5">
        <Link className="text-teal-500 hover:underline" href="/privacy-policy">Privacy Policy</Link>
        <Link className="text-teal-500 hover:underline" href="/terms-of-service"> Terms of Service</Link>
      </div>
    </footer>
  );
};
